...
```mermaid
graph TD
    Start["どこにデプロイする？🤔"] --> Q1{"Firebase Authや<br>SDKを直で使いたい？"}
    Q1 -- YES --> Functions["Cloud Functions (2nd gen)📣<br>onCallGenkitが最強"]
    Q1 -- NO --> Q2{"自由なWebサーバー<br>として動かしたい？"}
    Q2 -- YES --> CloudRun["Cloud Run🚀<br>コンテナで自由自在"]
    Q2 -- NO --> CRFunc["Cloud Run functions⚡<br>GCP標準の関数"]
```
